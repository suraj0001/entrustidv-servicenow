...
(function (outputs, steps, params, stepResult, assertEqual) {
  ...
  try {
    ...
    check(
      ...
      e.message,
      'Workflow ID must be 100 characters or fewer.'
    );
  }
  ...
  try {
    ...
    check(
      'Expected positive number validation message',
      e.message,
      'Link expiry must be a positive whole number.'
    );
  }
  ...
  check(
    'saveVerificationSettings should succeed with omitted redirect URL',
    saveNoRedirect.success,
    true
  );
  ...
  check(
    'saveVerificationSettings should succeed with a valid http redirect URL',
    saveHttpRedirect.success,
    true
  );
  ...
  try {
    ...
    check(
      ...
      e.message,
      'Webhook token must be between 5 and 100 characters.'
    );
  }
