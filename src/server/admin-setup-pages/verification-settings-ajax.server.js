  ...
  global.AbstractAjaxProcessor,
  {
    getConfig: () => {
      ...
      try {
        ...
        gs.error(
          "[Entrust IDV] Failed to load verification settings: " + e.message,
        );
    ...
    getWebhookSecretStatus: function () {
      ...
      try {
        ...
        return JSON.stringify(
          verificationSettingsService.getWebhookSecretStatus(),
        );
      } catch (e) {
        gs.error(
          "[Entrust IDV] Failed to load webhook token status: " + e.message,
        );
    ...
    saveConfig: function () {
      ...
      try {
        ...
        gs.error(
          "[Entrust IDV] Failed to save verification settings: " + e.message,
        );
    ...
    saveWebhookSecret: function () {
      ...
      try {
        ...
        return JSON.stringify(
          verificationSettingsService.saveWebhookSecret(
            this.getParameter("sysparm_webhook_secret"),
          ),
        );
      } catch (e) {
